...
- Improvements of existing code/functionality
      ...
      - Lower priority
            - Generalized FromLisp for union types. Maybe it's possible to check if the lisp value is of correct type. Maybe a can_from_lisp function on the FromLisp trait?
