...
The diagram below shows the most important aspects of the architecture. I got a lot of inspiration from [[https://github.com/zbelial/lspce][lspce]] and [[https://github.com/manateelazycat/lsp-bridge][lsp-bridge]] when deciding on this architecture.
